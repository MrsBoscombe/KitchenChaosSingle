...
public class OptionsUI : MonoBehaviour
{
    ...
    [SerializeField] private Transform pressToReybindKeyTransform;
    ...
    private void Awake(){
        ...
        // Rebind the binding in the GameInput
    ...
    private void Start(){
        // Adding this makes this canvas hide when the user clicks the ESC key along with the GamePauseUI
    ...
    private void ShowPressToRebindKey(){
        pressToReybindKeyTransform.gameObject.SetActive(true);
    }

    private void HidePressToRebindKey(){
        pressToReybindKeyTransform.gameObject.SetActive(false);
    }
